							...
							<div className="toolbar" id="kt_toolbar">
								...
								<div id="kt_toolbar_container" className="container-fluid d-flex flex-stack">
									...
									<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" className="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
										{/*begin::Title*/}
										<a href="/">
											<h1 className="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Inicio
									...
									<div className="d-flex align-items-center py-1">
										...
										<div className="me-4">
											...
											{/*begin::Menu 1*/}
											<div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61484bf44d957">
												{/*begin::Header*/}
												...
												<div className="px-7 py-5">
													...
													<div className="mb-10">
														...
														{/*begin::Input*/}
														<div>
															<select className="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61484bf44d957" data-allow-clear="true">
																<option />
					...
					<div id="kt_activities" className="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
						<div className="card shadow-none rounded-0">
													...
													<div className="notice d-flex bg-light-primary rounded border-primary border border-dashed min-w-lg-600px flex-shrink-0 p-6">
														...
														<div className="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
															...
															<div className="mb-3 mb-md-0 fw-bold">
																...
																<div className="fs-6 text-gray-700 pe-7">Login into Metronic Admin Dashboard to make sure the data integrity is OK</div>
															</div>
															{/*end::Content*/}
															{/*begin::Action*/}
							...
							<div className="card-footer py-5 text-center" id="kt_activities_footer">
								<a href="../../demo1/dist/pages/profile/activity.html" className="btn btn-bg-body text-primary">View All Activities
									{/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
					...
					<div id="kt_explore" className="bg-body" data-kt-drawer="true" data-kt-drawer-name="explore" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'350px', 'lg': '475px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_explore_toggle" data-kt-drawer-close="#kt_explore_close">
						...
						<div className="card shadow-none rounded-0 w-100">
							...
							<div className="card-header" id="kt_explore_header">
								<h3 className="card-title fw-bolder text-gray-700">Explore Metronic</h3>
								<div className="card-toolbar">
							...
							<div className="card-body" id="kt_explore_body">
								{/*begin::Content*/}
								<div id="kt_explore_scroll" className="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_explore_body" data-kt-scroll-dependencies="#kt_explore_header" data-kt-scroll-offset="5px">
									{/*begin::Wrapper*/}
									<div className="mb-0">
										{/*begin::Header*/}
										<div className="mb-7">
											<div className="d-flex flex-stack">
												...
												<a href="https://themeforest.net/licenses/standard" className="fw-bold" target="blank">License FAQs</a>
											</div>
										</div>
										{/*end::Header*/}
										{/*begin::License*/}
										...
										<div className="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
											<div className="d-flex flex-stack">
												...
												<div className="text-nowrap">
													<a href="https://keenthemes.com/contact/" className="btn btn-sm btn-success" target="blank">Contact Us</a>
												</div>
											</div>
										</div>
										{/*end::License*/}
										...
										<div className="mb-0">
											...
											<div className="row g-5">
												...
												<div className="col-6">
													...
													<div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
														<div className="overlay-wrapper">
															<img src="assets/media/demos/demo10.png" alt="demo" className="w-100 opacity-25" />
														</div>
														<div className="overlay-layer bg-dark bg-opacity-10">
												...
												<div className="col-6">
													...
													<div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
														<div className="overlay-wrapper">
															<img src="assets/media/demos/demo12.png" alt="demo" className="w-100 opacity-25" />
														</div>
														<div className="overlay-layer bg-dark bg-opacity-10">
															<div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
														</div>
												...
												<div className="col-6">
													...
													<div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
														<div className="overlay-wrapper">
															<img src="assets/media/demos/demo14.png" alt="demo" className="w-100 opacity-25" />
														</div>
														<div className="overlay-layer bg-dark bg-opacity-10">
															<div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
														</div>
												...
												<div className="col-6">
													...
													<div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
														<div className="overlay-wrapper">
															<img src="assets/media/demos/demo15.png" alt="demo" className="w-100 opacity-25" />
														</div>
														<div className="overlay-layer bg-dark bg-opacity-10">
															<div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
														</div>
												...
												<div className="col-6">
													...
													<div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
														<div className="overlay-wrapper">
															<img src="assets/media/demos/demo16.png" alt="demo" className="w-100 opacity-25" />
														</div>
														<div className="overlay-layer bg-dark bg-opacity-10">
															<div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
														</div>
												...
												<div className="col-6">
													...
													<div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
														<div className="overlay-wrapper">
															<img src="assets/media/demos/demo17.png" alt="demo" className="w-100 opacity-25" />
														</div>
														<div className="overlay-layer bg-dark bg-opacity-10">
															<div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
														</div>
												...
												<div className="col-6">
													...
													<div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
														<div className="overlay-wrapper">
															<img src="assets/media/demos/demo18.png" alt="demo" className="w-100 opacity-25" />
														</div>
														<div className="overlay-layer bg-dark bg-opacity-10">
															<div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
														</div>
												...
												<div className="col-6">
													...
													<div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
														<div className="overlay-wrapper">
															<img src="assets/media/demos/demo19.png" alt="demo" className="w-100 opacity-25" />
														</div>
														<div className="overlay-layer bg-dark bg-opacity-10">
															<div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
														</div>
												...
												<div className="col-6">
													...
													<div className="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
														<div className="overlay-wrapper">
															<img src="assets/media/demos/demo20.png" alt="demo" className="w-100 opacity-25" />
														</div>
														<div className="overlay-layer bg-dark bg-opacity-10">
															<div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
														</div>
												...
												<div data-kt-stepper-element="content">
													<div className="w-100 text-center">
														...
														<div className="text-center px-4 py-15">
															<img src="assets/media/illustrations/sketchy-1/9.png" alt className="w-100 mh-300px" />
														</div>
														{/*end::Illustration*/}
													</div>
												</div>
