...
const pagSecundaria = () => {
  return (
    <div>
      ...
      {/*begin::Head*/}
      <base href="../../" />
      <title>Metronic - Pag.Secundaria</title>
        ...
        <div className="d-flex flex-column flex-root">
          ...
          <div className="page d-flex flex-row flex-column-fluid">
              ...
              <div className="aside-menu flex-column-fluid">
                ...
                <div className="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset={0}>
                  ...
                  <div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                    ...
                    <div className="menu-item">
                      <a className="menu-link" href="../../demo1/dist/dashboards/no-toolbar.html">
                        <span className="menu-icon">
                      ...
                      <div className="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                          <span className="menu-link">
                            ...
                            <span className="menu-title">Projectos</span>
                            <span className="menu-arrow" />
                          </span>
                          <div className="menu-sub menu-sub-accordion menu-active-bg">
                            <div className="menu-item">
                              <a className="menu-link" href="../../demo1/dist/pages/projects/list.html">
                                ...
                                <span className="menu-title">My Projectos</span>
                              </a>
                            </div>
                            <div className="menu-item">
                      ...
                      <div className="menu-sub menu-sub-accordion menu-active-bg">
                        <div className="menu-item">
                          <a className="menu-link" href="../../demo1/dist/account/overview.html">
                            ...
                            <span className="menu-title">Overview 2</span>
                          </a>
                        </div>
                        <div className="menu-item">
                      ...
                      <div className="menu-sub menu-sub-accordion">
                        <div className="menu-item">
                          <a className="menu-link" href="../../demo1/dist/apps/support-center/overview.html">
                            ...
                            <span className="menu-title">Overview 3</span>
                          </a>
                        </div>
                        <div data-kt-menu-trigger="click" className="menu-item menu-accordion mb-1">
                          <span className="menu-link">
                    ...
                    <div data-kt-menu-trigger="click" className="menu-item here show menu-accordion">
                      ...
                      <div className="menu-sub menu-sub-accordion menu-active-bg">
                        <div className="menu-item">
                          <a className="menu-link active" href="../../demo1/dist/layouts/toolbars/toolbar-1.html">
                            <span className="menu-bullet">
                              <span className="bullet bullet-dot" />
                            </span>
            ...
            <div className="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                        ...
                        <div className="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                          <div className="menu-item me-lg-1">
                            <a className="menu-link py-3" href="../../demo1/dist/index.html">
                              <span className="menu-title">Dashboarddd</span>
                            </a>
                          </div>
                                    ...
                                    <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                      <div className="menu-item">
                                        <a className="menu-link py-3" href="../../demo1/dist/pages/profile/overview.html">
                                          ...
                                          <span className="menu-title">Overview 4</span>
                                        </a>
                                      </div>
                                      <div className="menu-item">
                                ...
                                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                  <div className="menu-item">
                                    <a className="menu-link py-3" href="../../demo1/dist/account/overview.html">
                                      ...
                                      <span className="menu-title">Overview 5</span>
                                    </a>
                                  </div>
                                  <div className="menu-item">
                                ...
                                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                  <div className="menu-item">
                                    <a className="menu-link py-3" href="../../demo1/dist/apps/support-center/overview.html">
                                      ...
                                      <span className="menu-title">Overview 6</span>
                                    </a>
                                  </div>
                                  <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
                                    <span className="menu-link py-3">
                          ...
                          <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item here show menu-lg-down-accordion me-lg-1">
                            ...
                            <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item here show menu-lg-down-accordion">
                                ...
                                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                  <div className="menu-item">
                                    <a className="menu-link active py-3" href="../../demo1/dist/layouts/toolbars/toolbar-1.html">
                                      <span className="menu-bullet">
                                        <span className="bullet bullet-dot" />
                                      </span>
                                      <span className="menu-title">Toolbar 1</span>
                ...
                <div className="toolbar" id="kt_toolbar">
                  ...
                  <div id="kt_toolbar_container" className="container-fluid d-flex flex-stack">
                    ...
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" className="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                      {/* ================= MIGA DE PAN =================== */}
                      {/*begin::Title*/}
                      <h1 className="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Pag.Secundaria</h1>
                      {/*end::Title*/}
                      {/*begin::Separator*/}
                      ...
                      <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        {/*end::Item*/}
                        {/*begin::Item*/}
                        <li className="breadcrumb-item text-muted">Toolbars</li>
                        {/*end::Item*/}
                        {/*begin::Item*/}
                        <li className="breadcrumb-item">
                          <span className="bullet bg-gray-200 w-5px h-2px" />
                        ...
                        {/*end::Item*/}
                        {/*begin::Item*/}
                        <li className="breadcrumb-item text-dark">Pag.Secundaria</li>
                        {/*end::Item*/}
                      </ul>
                      {/*end::Breadcrumb*/}
                    </div>
              ...
              <div className="container py-4 text-center bg-primary">
