                    ...
                    <div className="col-xxl-4">
                      ...
                      <div className="card card-xxl-stretch">
                        ...
                        <div className="card-header border-0 bg-danger py-5">
                          <h3 className="card-title fw-bolder text-white">Página Primaria !!!</h3>
                      ...
                      <div className="card card-xxl-stretch">
                        ...
                        <div className="card-header align-items-center border-0 mt-4">
                          ...
                          <div className="card-toolbar">
                            ...
                            {/*begin::Menu 1*/}
                            <div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61484bf44f851">
                              {/*begin::Header*/}
                              ...
                              <div className="px-7 py-5">
                                ...
                                <div className="mb-10">
                                  ...
                                  {/*begin::Input*/}
                                  <div>
                                    <select className="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61484bf44f851" data-allow-clear="true">
                                      <option />
